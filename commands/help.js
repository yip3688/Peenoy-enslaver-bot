...
module.exports = {
  name: "help",
  description: "Why the fuck do you need help?",
  usage: "[command]",
  permissions: {
  ...
  Retard music bot: v${require("../package.json")}
   | [discord server](https://discord.gg/7YCuFYP9Gs) | By [TheTrueNiggerOfServer](https://discord.gg/7YCuFYP9Gs)`);
